...
const ProjectCard = ({ project }: { project: Project }) => {
	return (
		<Link className='block transform transition duration-300 hover:scale-[1.02]' to={`/projects/${project.id}`}>
			<div className='bg-gray-800 border border-gray-700 rounded-lg overflow-hidden shadow-sm transition hover:shadow-md duration-300'>
				<div>
					<img className='w-full h-40 object-cover' src={project.image} alt={project.title} />
				</div>
				<div className='p-5'>
